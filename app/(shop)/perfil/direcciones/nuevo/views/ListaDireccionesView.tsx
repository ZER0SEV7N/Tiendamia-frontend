...
export default function MisDireccionesView() {
  ...
  return (
    <div className="w-full max-w-6xl font-sans pl-2 pb-10 animate-in fade-in-50 duration-500 mx-auto">
      <div className="w-full">
        ...
        {direcciones.length > 0 ? (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      {dir.referencia && (
                        <p className="text-sm text-gray-600 mb-3">📍 {dir.referencia}</p>
                      )}
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                  ...
                  <div className="flex gap-2">
                    <Button
                      onClick={() => router.push(`/perfil/direcciones/${dir.id}/editar`)}
          ...
          <div className="text-center py-16 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">No tienes direcciones registradas</h3>
