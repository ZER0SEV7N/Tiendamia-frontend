...
export default function NuevaDireccionView() {
  ...
  // Estado del formulario con datos iniciales basados en image_48cd43.png
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Dirección guardada con éxito:", formData);
    // Redirige de vuelta al listado general de direcciones al guardar
  ...
  return (
    <div className="w-full max-w-4xl font-sans space-y-6 pl-2 pb-10 animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-8 pt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-neutral-700 flex items-center gap-1">
                ...
                <HelpCircle className="w-4 h-4 text-blue-500 stroke-[2]" />
              </label>
              <Input
                type="text"
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className="h-12 border-neutral-300 text-neutral-500">
        ...
        {/* ================= SECCIÓN: DIRECCIÓN DE ENVÍO A PERÚ ================= */}
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className="h-12 border-neutral-300 text-neutral-400 bg-neutral-50 disabled:opacity-70">
            ...
            <div className="space-y-2">
              ...
              <div className="flex rounded-md border border-neutral-300 overflow-hidden bg-white focus-within:ring-2 focus-within:ring-neutral-400 focus-within:border-transparent transition-all">
                {/* Contenedor estático del prefijo de Perú */}
